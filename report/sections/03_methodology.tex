...
Specifically, the analytical strategy maps onto the three research questions as follows: RQ1 (spatial environment and gym intimidation) is addressed primarily through Items 10--18 (spatial pressure/training anxiety, avoidance frequency, and avoidance reasons) supplemented by Spearman correlations and interview themes on spatial visibility and male-dominated atmosphere; RQ2 (social media appearance norms and exercise preferences) is addressed through Items 19--23 (social media use and appearance internalization), exploratory correlations with avoidance frequency, and interview themes on appearance influence; RQ3 (negotiation between health motivation and appearance norms) is addressed through interview themes on strategic negotiation and coping strategies, supplemented by Items 16--18 (avoidance behaviors and coping) and Item 24 (training self-efficacy).
